...
<body>
	...
	<div class="headr">
		<div class="heard-con">
			...
			<div class="headr-nav">
				<ul>
					<li><a href="index.jsp" style="color: #4AB344"><span
							style="color: #4AB344">首页</span></a></li>
			...
			<div class="rec-cont clear">
				...
				<div class="rec-right">
					...
					<div class="rcr">
						...
						<div class="rcr-bot">
							<div class="rb-top">南非进口黄柠檬 6个装</div>
							<div class="second_P">
							...
							<div class="buy">
								<a class="second_mallBuy" href="#"> <span
									style="color: white;">购买</span>
								</a>
							</div>
						</div>
					</div>
					<div class="rcr">
						...
						<div class="rcr-bot">
							<div class="rb-top">智利进口新鲜蓝莓 4盒</div>
							<div class="second_P">
								<span class="fk-prop">￥</span> <span class="fk-prop-price">99
									<span class="fk-prop-p">.00</span>
								</span> <span class="second_Marketprice">￥0.00</span>
							</div>
							<div class="buy">
					...
					<div class="rcr">
						...
						<div class="rcr-bot">
							...
							<div class="second_P">
								<span class="fk-prop">￥</span> <span class="fk-prop-price">48
									<span class="fk-prop-p">.00</span>
								</span> <span class="second_Marketprice">￥0.00</span>
							</div>
							<div class="buy">
					...
					<div class="rcr">
						...
						<div class="rcr-bot">
							<div class="rb-top">美国进口无籽红提 1kg</div>
							<div class="second_P">
					...
					<div class="rcr">
						...
						<div class="rcr-bot">
							<div class="rb-top">浙江涌泉蜜桔无核桔子5斤</div>
							<div class="second_P">
								<span class="fk-prop">￥</span> <span class="fk-prop-price">39
									<span class="fk-prop-p">.00</span>
								</span> <span class="second_Marketprice">￥0.00</span>
	...
	<div class="rec-bottom clear">
		<div class="rbt-con">
			<div class="banner_1">
				<img src="images/rb-1.jpg" width="1424px"> <img
					src="images/rb-2.jpg" width="1424px">
			</div>
		</div>
	...
	<div class="content">
		<div class="new-nav clear">
			<div class="nwn-con">
				<div style="text-align: center;">
					<span style=""> <span style="font-size: 31px;"> <font
							style="color: rgb(33, 33, 33);" color="#212121"> <font
								style="color: rgb(231, 231, 231);" color="#e7e7e7">
									——————— </font> <b>&nbsp; 每日新品特卖 &nbsp;</b>
						</font></span></span> <span style="font-size: 31px;"> <font
						style="color: rgb(231, 231, 231);" color="#e7e7e7"> ———————
					</font>
					</span>
				</div>
				<div style="text-align: center;">
					<font color="#353535" style=""> <span
						style="font-size: 16px;"> <font style="color: #888888">
								新鲜水果每一天，健康生活每一刻 </font>
					</span>
					</font>
				</div>
		...
		<div class="new-con clear">
			<div class="nec-lift">
				<div class="fk-editor simpleText  ">
					<font color="#4b4b4b"> <span style=""> <span
							style="line-height: 29px;"> <span
								style="color: rgb(75, 75, 75); font-size: 16px;"> 有机生鲜 </span>
								<div style="color: rgb(75, 75, 75);">
									<span style="font-size: 20px;"> 天然无污染水果 </span>
								</div>
						</span>
					</span>
						<div style="color: rgb(75, 75, 75);">
						...
						<div>
							<font style="color: rgb(243, 151, 0);" color="#f39700"> <b>
									<span style="font-size: 42px;">6.8</span>
							</b><span style="font-size: 42px;"> <b>折</b> <span
									style="font-size: 18px;"> <font
										style="color: rgb(53, 53, 53);" color="#353535">起</font>
								</span></span></font>
						</div>
					</font>
				</div>
		...
		<div class="fruits">
			<div class="fru-nav">
				...
				<a style="color: rgb(53, 53, 53); float: right">更多资讯</a>
			</div>
			<div class="fru-lift">
				<div class="frl-nav">
					<ul>
					...
					<div class="bd">
						<ul>
							<li><a href="#" target="_blank"><img
									src="images/fr-1.jpg" /></a></li>
							<li><a href="#" target="_blank"><img
									src="images/fr-2.jpg" /></a></li>
							<li><a href="#" target="_blank"><img
									src="images/fr-3.jpg" /></a></li>
						</ul>
					</div>
